      ...
      <div className="bg-white dark:bg-[#070c17] rounded-2xl shadow-2xl w-full max-w-md flex flex-col" style={{ maxHeight: '90vh' }}>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
          ...
          {deptTasks && deptTasks.length > 1 && (
            <div>
              <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1.5">Under which task? *</label>
          ...
          <div>
            <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1.5">Subtask Title *</label>
            <input autoFocus value={form.title} onChange={e => set('title', e.target.value)}
              onKeyDown={e => e.key === 'Enter' && submit()}
              placeholder="e.g. Design packaging label" className="input w-full" />
          </div>
          <div>
            <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1.5">Instructions</label>
          ...
          <div>
            <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1.5">Assign to Member</label>
