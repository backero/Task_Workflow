...
router.post('/leads/:id/samples', authorizeManagerOrAbove, ctrl.createVersionedSample);
router.put('/leads/:id/samples/:sampleId', authorizeManagerOrAbove, ctrl.updateVersionedSample);
router.put('/leads/:id/samples/:sampleId/status', authorizeManagerOrAbove, ctrl.updateVersionedSampleStatus);
router.post('/leads/:id/samples/:sampleId/feedback', authorizeManagerOrAbove, ctrl.addSampleFeedback);
