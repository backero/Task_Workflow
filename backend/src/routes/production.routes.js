...
const {
  ...
  recordQualityTest, stockInRawMaterial, adHocMaterialUsage,
...
router.post('/stock-in',          requireMinRole('MANAGER'), stockInRawMaterial);
router.post('/use-material',      requireMinRole('MANAGER'), adHocMaterialUsage);
